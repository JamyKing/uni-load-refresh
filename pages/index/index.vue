<template>
	<view class="content">
		<load-refresh ref="loadRefresh" :backgroundCover="'#F3F5F5'" :pageNo="currPage" :totalPageNo="totalPage" :isRefresh="true" refreshType="halfCircle" :refreshTime="800" @loadMore="loadMore" @refresh="refresh">
